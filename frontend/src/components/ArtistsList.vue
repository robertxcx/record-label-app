  ...
  <article class="container-fluid">
    ...
    <div class="row justify-content-center py-3 px-0">
      ...
      <div
        ...
        :key="artist.id"
      >
      <div class="card border-2 border-light rounded-4 card-hover">
          <div class="card-body">
            <header>
            ...
            >
              <div class="fw-bold" style="color: black;">Genre:</div>
              <div style="color: black;">{{ artist.genre }}</div>
            </div>

            <div
              class="d-flex justify-content-between align-items-center border border-2 border-dark p-2 my-2"
            >
              <div class="fw-bold" style="color: black;">Country:</div>
              <div style="color: black;">{{ artist.country }}</div>
            </div>

            <button
              class="btn btn-dark fw-bold  d-flex justify-content-center align-items-center gap-2 mx-auto mt-3"
              type="button"
